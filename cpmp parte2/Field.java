...
public class Field 
{
	...
	/*public static int bestColumn()
	{
		...
		for (i=0;i<columns.size();i++)
		{
			...
			int oracle=temp.indexOf(oracle());
			if(oracle!=-1)
			{
		...
		int rnd=(int)(Math.random()*(minNum-1));
	...
	*/
	...
	public Field copyPaste()
	{
		Field nuevo=new Field();
		
		nuevo.setMovs(this.getMovs());
		nuevo.setHMax(this.getHMax());
